...
**当前稳定版：** [v0.4.17](https://github.com/deltrivx/workbuddy-switch/releases/tag/v0.4.17)
...
|---|---|---|---|
| [v0.4.17](https://github.com/deltrivx/workbuddy-switch/releases/tag/v0.4.17) | 2026-09-23 | 新增 GitHub 账号自动化接入，浏览器改为运行时下载到挂载卷 | — |
...
docker pull ghcr.io/deltrivx/workbuddy-switch:0.4.17    # 锁定版本
```
